import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{r as _}from"./index-BZISi7jw.js";import{A as j}from"./Alert-BJzkBjVg.js";import{T as O}from"./ThemeProvider-D8qwjXKu.js";import{u as q}from"./index-D8d2bdkj.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BtkQkHPN.js";const J={title:"Components/Alert",component:j,argTypes:{type:{control:{type:"select",options:["success","error","warning","info"]}},dismissible:{control:"boolean"},onClose:{action:"closed"},icon:{control:"text"},className:{control:"text"},style:{control:"object"},title:{control:"text"},duration:{control:"number"},ariaLabel:{control:"text"}}},e=d=>{const[W,w]=_.useState(!0),E=q();if(!W)return s.jsx("div",{children:"No alert visible"});const I=()=>{w(!1),d.onClose&&d.onClose()};return s.jsx(O,{children:s.jsx("div",{className:E?"dark-theme":"",children:s.jsx(j,{...d,onClose:I})})})},r=e.bind({});r.args={message:"This is an informational alert.",type:"info",dismissible:!0};const n=e.bind({});n.args={message:"Operation completed successfully!",type:"success",dismissible:!0};const o=e.bind({});o.args={message:"There was an error processing your request.",type:"error",dismissible:!0};const i=e.bind({});i.args={message:"Warning: Please check your input.",type:"warning",dismissible:!1};const t=e.bind({});t.args={message:"This is an alert with an icon.",type:"info",icon:s.jsx("i",{className:"icon-info"}),dismissible:!0};const a=e.bind({});a.args={message:"This is an alert with a title.",type:"info",title:"Alert Title",dismissible:!0};const l=e.bind({});l.args={message:"This alert will auto-dismiss after 3 seconds.",type:"info",duration:3e3,dismissible:!0};var c,m,u;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`args => {
