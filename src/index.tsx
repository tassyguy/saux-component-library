...
const StyleGuide: React.FC = () => {
  return (
    <div>
      ...
      // Container component goes here // Grid System component goes here //
      Section/Wrapper component goes here
      <p>Navigation Components</p>
      // Header/Nav Bar component goes here // Sidebar component goes here //
      Breadcrumb component goes here // Footer component goes here
      <p>UI/Interactive Components</p>
      <Button
        label="This is a button component"
        onClick={() => alert('This is a button alert!')}
      />{' '}
      ...
      <p>Form Components</p>
      // Input Field component goes here // Textarea component goes here //
      Select/Dropdown Input component goes here // Checkbox/Radio Button goes
      here // Form & FormGroup component goes here // Toggle Switch component
      goes here
